...
class VillageListActivity : BaseActivity<ActivityCommonListBinding, VillageListViewModel>(),
    ...
    var arrayList: ArrayList<VillageData> = ArrayList()
...
//                }
    ...
    override fun init() {
        ...
        viewDataBinding!!.recyclerStudentList.layoutManager = LinearLayoutManager(this)
        ...
        viewDataBinding!!.recyclerStudentList.setHasFixedSize(true)
        viewDataBinding!!.recyclerStudentList.adapter = mAdapter

    }

    private fun showAddDialog(data: VillageData?) {
