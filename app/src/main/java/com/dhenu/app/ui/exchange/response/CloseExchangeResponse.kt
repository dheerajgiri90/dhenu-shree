...
class CloseExchangeResponse : BaseResponse<CloseExchangeResponse, String, Any>() {
    ...
    override fun doNetworkRequest(
        ...
        vararg: Any,
        networkResponseCallback: NetworkResponseCallback<CloseExchangeResponse>
    ): Disposable {

        val api = ApiFactory.clientWithHeader.create(Api::class.java)
        Logger.e("requestParam>>>>>", "" + requestParam.toString())

        return api.closeExchangeItem(requestParam).subscribeOn(Schedulers.io())
